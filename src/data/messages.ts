...
const step11Actions =
  ...
  "_Утренняя Часть_\n\n" +
  "_Одиннадцатый шаг предлагает молитву и (медитацию) углубленное размышление. Она помогает при усердии и соответствующем отношении к ней. Мы можем предложить кое-что ценное и определенное._\n\n" +
